...
namespace VotGESOrders.Web.Models
{
    ...
    public sealed partial class Order : Entity
    {
        ...
        // 
        // - Атрибут "System.ComponentModel.DataAnnotations.RoundtripOriginalAttribute" не виден в клиентском проекте "VotGESOrders". Возможно, отсутствует ссылка на сборку.
    ...
    public sealed partial class OrdersUser : Entity
    {
        ...
        private bool _canFinishCranTask;
        ...
        partial void OnCanFinishCranTaskChanging(bool value);
        ...
        /// <summary>
        /// Возвращает или задает значение параметра "AddLogins".
        /// </summary>
        [DataMember()]
        public string AddLogins
        {
            get
            {
                return this._addLogins;
            }
            set
            {
                if ((this._addLogins != value))
                {
                    this.OnAddLoginsChanging(value);
                    this.RaiseDataMemberChanging("AddLogins");
                    this.ValidateProperty("AddLogins", value);
                    this._addLogins = value;
                    this.RaiseDataMemberChanged("AddLogins");
                    this.OnAddLoginsChanged();
                }
            }
        }
        ...
        /// <summary>
        /// Возвращает или задает значение параметра "CanFinishCranTask".
        /// </summary>
        [DataMember()]
        public bool CanFinishCranTask
        {
            get
            {
                return this._canFinishCranTask;
            }
            set
            {
                if ((this._canFinishCranTask != value))
                {
                    this.OnCanFinishCranTaskChanging(value);
                    this.RaiseDataMemberChanging("CanFinishCranTask");
                    this.ValidateProperty("CanFinishCranTask", value);
                    this._canFinishCranTask = value;
                    this.RaiseDataMemberChanged("CanFinishCranTask");
                    this.OnCanFinishCranTaskChanged();
                }
            }
        }
